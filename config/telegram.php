...
return [
    ...
    */
    'bots' => [
        'operator-bot' => [
            'token' => env('TELEGRAM_BOT_TOKEN_OPERATOR'),
            // 'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            // 'webhook_url' => env('APP_URL') . "/api/webhook/for-operators",
            // 'commands' => [
            //     //Acme\Project\Commands\MyTelegramBot\BotCommand::class
            // ],
        ],
        'dealer-bot' => [
            'token' => env('TELEGRAM_BOT_TOKEN_DEALER'),
            // 'webhook_url' => env('APP_URL') . "/api/webhook/for-dealers",
        ],
        'user-bot' => [
            'token' => env('TELEGRAM_BOT_TOKEN_USER'),
            // 'webhook_url' => env('APP_URL') . "/api/webhook/for-users",
        ],
    ],
