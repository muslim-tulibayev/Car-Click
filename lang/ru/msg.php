...
return [
    ...
    'car_info' => "🆔 ID: :id\n"
        ...
        . "🆕 Состояние: :condition\n"
        . "💬 Дополнительно: :additional\n"
        . "🙍‍♂️ Владелец: :owner_fname :owner_lname\n"
    ...
    'channel_link_for_dealer' => "Вы можете следить за уведомлениями о новых аукционах на этом канале.\n"
    ...
    'auction_info' => "📈 Самая высокая цена: :highest_price\$\n"
        . "💵 Начальная цена: :starting_price\$\n"
