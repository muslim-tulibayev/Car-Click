...
return [
    ...
    'finished' => "Готово",
    'cannot_cancel_task' => "‼️ К сожалению, вы не можете отменить операцию, поскольку кроме вас нет другого оператора.",
    'task_ignored' => " ✅ Задача успешно проигнорирована.",
    'empty_task' => "☑️ Нет задачи",
    'done' => "Готово",
    'cannot_logout_because_of_task' => "‼️ К сожалению, вы не можете выйти из системы, поскольку у вас есть задача и нет другого оператора, которому можно было бы назначить задачу.",
