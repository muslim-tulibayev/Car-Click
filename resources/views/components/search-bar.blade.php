<div class="w-[50%] mx-auto flex items-center h-9 rounded-lg border overflow-hidden px-2">

    <div class="relative inline-flex border-r">
        ...
        <select id="searchSelect" class="text-gray-500 px-[10px] outline-none appearance-none">
    ...
    <input type="text" id="searchInput" onkeydown="onInput()" value="{{ $oldval }}"
        ...
        placeholder="Search something..." class="flex-1 outline-none text-gray-500 px-2" />

    <button onclick="search()" class="flex items-center justify-center text-gray-500 pl-2 border-l">
