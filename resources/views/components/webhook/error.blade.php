    ...
    <div class="flex justify-between flex-wrap">
        <div class="w-0 flex-1 flex">
            ...
            <div>
                ...
                <div class="flex mt-3">
                    <button type="button" onclick="alertError.classList.add('hidden')"
                        class="w-full inline-flex
                        justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base
        ...
        <div> <button type="button" onclick="alertError.classList.add('hidden')"
                class="rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"> <svg width="24"
                    height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                    <path
